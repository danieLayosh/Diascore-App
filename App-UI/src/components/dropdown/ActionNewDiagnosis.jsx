...
export default function ActionNewDiagnosis() {
  ...
  const handleReturnWithoutSave = async () => {
      ...
      <DropdownMenu aria-label="Dropdown menu with description" variant="faded">
        ...
        <DropdownSection title="Danger zone">
          <DropdownItem
            ...
            color="danger"
            description="Return back without saving"
            onPress={handleReturnWithoutSave}
            startContent={<IoArrowUndo className={cn(iconClasses, "text-danger")} />}
          >
